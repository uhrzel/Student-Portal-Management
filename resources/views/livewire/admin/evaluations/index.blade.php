<div>
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto space-y-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-row justify-between items-center">
                ...
                <a wire:navigate href="{{ route('admin.evaluations.create') }}">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            <!-- <div x-data="{ open: false, archiveStatus: 'Active' }" class="relative">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            ...
                            <tr wire:key="{{ $evaluation->id }}" class="border-b">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{{ $evaluation->title }}</th>
                                <td class="px-4 py-3">{{ $evaluation->description }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <div x-data="{ open: false }">
                                        ...
                                        <div x-show="open" @click.away="open = false" class="absolute z-10 w-44 right-10 bg-white rounded divide-y divide-gray-100 shadow">
                                            ...
                                            <div class="py-1">
                                                <button @click="$dispatch('open-modal', { id: {{ $evaluation->id }} })" class="block w-full text-left py-2 px-4 text-sm text-red-700 hover:bg-gray-100">Delete</button>
                                            </div>
                                            @endif
                                            @if($evaluation->deleted_at !== null)
                                            <div class="py-1">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="px-4 py-3 text-center">No evaluations found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    <!-- Modal Delete -->
    <div x-data="{ showModal: false, evaluationId: null }"
        @open-modal.window="showModal = true; evaluationId = $event.detail.id"
        x-show="showModal"
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-lg w-full">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Are you sure you want to delete this evaluation? This action cannot be undone.</p>
                    ...
                    <div class="mt-4 flex space-x-3">
                        ...
                        <button @click="$wire.deleteEvaluation(evaluationId); showModal = false" type="button" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                            Delete
                        </button>
                    </div>
                </div>
    ...
    <!-- Modal Restore -->
    <div x-data="{ showRestoreModal: false, evaluationId: null }"
        @restore-evaluation.window="showRestoreModal = true; evaluationId = $event.detail.id"
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-lg w-full">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Are you sure you want to restore this evaluation?</p>
                    ...
                    <div class="mt-4 flex space-x-3">
                        ...
                        <button @click="$wire.restoreEvaluation(evaluationId); showRestoreModal = false" type="button" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                            Restore
                        </button>
                    </div>
                </div>
    ...
    <!-- Modal Force Delete -->
    <div x-data="{ showForceDeleteModal: false, evaluationId: null }"
        @force-delete-evaluation.window="showForceDeleteModal = true; evaluationId = $event.detail.id"
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-lg w-full">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Are you sure you want to permanently delete this evaluation? This action cannot be undone.</p>
                    ...
                    <div class="mt-4 flex space-x-3">
                        ...
                        <button @click="$wire.forceDeleteEvaluation(evaluationId); showForceDeleteModal = false" type="button" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                            Delete Permanently
                        </button>
                    </div>
                </div>
