    ...
    <div class="max-w-sm w-full bg-white rounded-lg shadow p-4 md:p-6">
        <div class="flex justify-between pb-4 mb-4 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    <h5 class="leading-none text-2xl font-bold text-gray-900 pb-1">{{ $averageGrade }}</h5>
                    <p class="text-sm font-normal text-gray-500">Average Grade</p>
                </div>
            </div>
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm font-normal text-gray-500">Average Failed Subjects</p>
                </div>
            </div>
        </div>
